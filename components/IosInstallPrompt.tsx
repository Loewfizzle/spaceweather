          ...
          >
            ...
            <ol className="space-y-4 mb-6">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-[#94a3b8]">
                  Tap <span className="text-white font-medium">&ldquo;Add to Home Screen&rdquo;</span>
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#22c55e] font-semibold text-xs mt-0.5 shrink-0 w-4">4</span>
                <span className="text-sm text-[#94a3b8]">
