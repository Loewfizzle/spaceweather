        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-0">
            <div className="flex items-center gap-2">
              ...
              <span id="meteor-shower-modal-title" className="uppercase tracking-[2px] text-[10px] text-[#64748b]">
                Meteor Shower
              </span>
            </div>
            <button
          ...
          <div className="px-5 pb-5 pt-4 space-y-5">
            ...
            <div className="rounded-lg border border-[#1e2937] bg-[#0a0f1e] px-4 py-3">
              ...
              <div className="text-[12px] text-[#64748b] mt-0.5">{formatMeteorPeak(peakDate, shower)}</div>
              <div className="mt-2">
                <span
