        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-0">
            <div className="flex items-center gap-2">
              ...
              <span id="fireballs-modal-title" className="uppercase tracking-[2px] text-[10px] text-[#64748b]">
                Fireball Tracker
              </span>
            </div>
            <button
          ...
          <div className="px-5 pb-5 pt-4 space-y-5">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-3 text-[12px]">
                  <span className="flex items-center gap-1.5 flex-shrink-0 w-[80px]">
                    ...
                    <span className="font-semibold text-[#64748b]">&lt; 0.1 kt</span>
                  </span>
                  <span className="text-[#64748b] leading-relaxed">
              ...
              <p className="text-[12px] text-[#64748b] leading-relaxed mt-2.5">
